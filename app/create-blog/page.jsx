    ...
    <section className="container max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          >
            <option value="Local Insider Tips">Local Insider Tips</option>
            <option value="Food-Focused Travel">Food-Focused Travel</option>
            <option value="Adventure and Outdoor Travel">Adventure and Outdoor Travel</option>
            <option value="Sustainable Travel">Sustainable Travel</option>
            <option value="Family-Friendly Travel">Family-Friendly Travel</option>
            <option value="Travel and Technology">Travel and Technology</option>
          </select>
        </div>
